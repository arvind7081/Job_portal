...
class AccountController extends Controller
{
    ...
    public function updateProfilePic(Request $request){
        ...
        if($validator->passes()){
            ...
            session()->flash('success', 'Proflile picture updated successfully.');
              return response()->json([
                'status' => true,
                'errors' => []
            ]);
    ...
    public function updatePassword(Request $request){
        ...
        if (Hash::check($request->old_password, Auth::user()->password) == false) {
            session()->flash('error', 'Your old password incorrect');
            return response()->json([
                'status' => true,
            ]);
        }
    ...
    public function processForgotPassword(Request $request){
        ...
        return redirect()->route('account.forgotPassword')->with('success', 'Reset password email has been to your inbox.');
    }
