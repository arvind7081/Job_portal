                                            ...
                                            <td>
                                                <div class="action-dots ">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a class="dropdown-item" href="{{ route('jobsDetail', $savedJob->job_id) }}"> <i class="fa fa-eye" aria-hidden="true"></i> View</a></li>
...
{{-- <script type="text/javascript">
  function removeJob(id) {
    if (confirm("Are you aure you want to remove?")) {
        $.ajax({
...
<script>
    ...
    if (confirm("Are you sure you want to remove?")) {
        $.ajax({
            ...
            dataType: 'json',
            success: function(response){
                let alertType = response.status ? 'success' : 'danger';
                $('.card-body').prepend(
