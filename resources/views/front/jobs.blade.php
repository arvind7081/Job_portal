                    ...
                    <div class="card border-0 shadow p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="experience" id="experience" class="form-control">
                                ...
                                <option value="2" {{ (Request::get('experience') == 1) ? 'selected' : '' }}>2 Years</option>
                                <option value="1" {{ (Request::get('experience') == 2) ? 'selected' : '' }}>1 Year</option>
                ...
                <div class="job_listing_area">                    
                    ...
                    <div class="row">
                        @if ($jobs->isNotEmpty())
                            ...
                            @else
                            <div class="col-md-6">Jobs not found</div>
                        @endif
...
<script>
    $("#searchForm").submit(function(e){
        ...
        // If  has a value categroy
        if (category!= "") {
           url += '&category='+category; 
        }

        // If  has a value Experience
        if (experience!= "") {
