...
Route::group(['prefix' => 'account'], function(){
    // 🟢 Guest-only routes (accessible if NOT logged in)
    ...
    // 🔐 Authenticated-only routes (accessible only if logged in)
    Route::middleware('auth')->group(function () {
        ...
        Route::post('/update-jobs/edit/{jobId}', [AccountController::class, 'updateJob'])->name('account.updateJobs');
